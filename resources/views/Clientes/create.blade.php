...
<div class="max-w-3xl mx-auto">
    <h1 class="text-2xl font-bold text-slate-800 mb-6">Registrar nuevo cliente</h1>

    <form action="{{ route('clientes.store') }}" method="POST" x-data="{ seccion: 'datos' }">
        @csrf
            ...
            <div x-show="seccion === 'camisa'" x-cloak class="px-4 pb-4 grid grid-cols-2 gap-4">
                @foreach ([
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="{{ $campo }}" value="{{ old($campo) }}"
                            class="mt-1 w-full rounded border-slate-300 focus:ring-primary-500 focus:border-primary-500">
        ...
        <div class="bg-white rounded-lg shadow mb-4">
            ...
            <div x-show="seccion === 'generales'" x-cloak class="px-4 pb-4">
                ...
                <input type="number" step="0.01" name="largo_total" value="{{ old('largo_total') }}"
                    class="mt-1 w-full rounded border-slate-300 focus:ring-primary-500 focus:border-primary-500">
        ...
        <div class="bg-white rounded-lg shadow mb-4">
            ...
            <div x-show="seccion === 'notas'" x-cloak class="px-4 pb-4">
                <textarea name="notas" rows="3"
                    class="mt-1 w-full rounded border-slate-300 focus:ring-primary-500 focus:border-primary-500">{{ old('notas') }}</textarea>
